...
## Write a short comment describing this function
## The function below evaluates the inverse of the given "special
## matrix" and returns it. But before it does, it checks the cache
## of the data, and if there is one, the function doesn't calculate
## and just returns the cached inverse.
